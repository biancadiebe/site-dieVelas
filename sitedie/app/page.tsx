...
export default function Home() {
    ...
    <p><a href="#" className={styles['sub-texto']}>Ver todos <FaLongArrowAltRight /></a></p>

		<div className={styles.divVendas}>
		<CardVenda icon={<MdOutlineShoppingCart />} label="Compre agora" title="Vela de Cera Natural" price="29,90" img="/imagens/velabubble.jpg" />
		<CardVenda icon={<MdOutlineShoppingCart />} label="Compre agora" title="Vela de Cera Natural" price="29,90" img="/imagens/velabubble.jpg" />
		<CardVenda icon={<MdOutlineShoppingCart />} label="Compre agora" title="Vela de Cera Natural" price="29,90" img="/imagens/velabubble.jpg" />
		</div>
